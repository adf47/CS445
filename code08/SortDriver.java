...
public class SortDriver
{
    ...
    public static void main(String args[])
    {
        ...
        trials = getInt("   Enter number of trails.");
        ...
        // ADD CODE TO REPORT THE NUMBER OF COMPARISONS
          ...
          System.out.println("  total comparisons: "+sai.getTotalComparisons());
          System.out.println("  Minimum number of comparisons: "+sai.getMinComparisons());
          System.out.println("  Max number of comparisons: "+sai.getMaxComparisons());

          //computing the avergaes
          double avg = sai.getTotalComparisons()/trials;
          System.out.println("  The average number of comparisons: "+avg);
