...
public class SortArray
{
    ...
    public static <T extends Comparable<? super T>>
    void bitonicMergeSort(T[] a, T[] tempArray, int first, int last)
    {

        if(first < last)        // We have some work to do
        {
            int mid = first + (last-first)/2;
            bitonicMergeSort(a, tempArray, first, mid);
            bitonicMergeSort(a, tempArray, mid+1, last);
            bitonicMerge(a, tempArray, first, mid, last);
        }
    ...
    void bitonicMergeSort(T[] a, int first, int last)
    {
        ...
        @SuppressWarnings("unchecked")
        T[] tempArray = (T[]) new Comparable<?>[a.length]; // Unchecked cast
        bitonicMergeSort(a, tempArray, first, last);
    } // end mergeSort
    ...
    * @return The index of the pivot */
    ...
    public static <T extends Comparable<? super T>>
    void bitonicMerge(T[] a, T[] tempArray, int first, int mid, int last)
    {
        int beginHalf1 = first;
        int endHalf1 = mid;
        int beginHalf2 = mid + 1;
