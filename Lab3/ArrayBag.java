...
public final class ArrayBag<T> implements BagInterface<T> {
    ...
    {
    	Random r = new Random();
   	    int rem = r.nextInt(numberOfEntries) + 1;
        result = removeEntry(rem - 1);
...
// equals bag[where]; otherwise, anEntry is not in the array
    ...
    public boolean equals(ArrayBag<T> aBag) {
        ...
        Object [] origBag = new Object[numberOfEntries];
        
        for(int z = 0;z<numberOfEntries;z++)
        {
        	origBag[z] = bag[z];
        }
